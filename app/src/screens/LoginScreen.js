      ...
      <ScrollView contentContainerStyle={{flexGrow: 1, justifyContent: 'center'}} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.inputCard}>
          ...
          <View style={styles.buttonContainer}>
            <TouchableOpacity style={styles.customLoginButton} onPress={handleLogin}>
              <Text style={styles.loginButtonText}>GİRİŞ YAP</Text>//Button yazısı
            </TouchableOpacity>
...
const styles = StyleSheet.create(
  ...
  { 
    ...
    fontWeight: '900', 
    textAlign: 'center', 
    color: '#fff', // Açık zeminde beyaz daha şık durur
    letterSpacing: 2,
